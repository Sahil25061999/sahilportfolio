...
var scroll = new (0, _locomotiveScrollDefault.default)({
...
const headerClipAnimate = (e, interacting)=>{
    ...
    tl.to(".foreground", {
        overwrite: "auto",
        duration: ".5",
        "clip-path": `circle(${interacting ? "8rem" : "0rem"} at ${Math.min(Math.max(0, (e.clientX - bcr.left) / bcr.width), 1) * 100}% ${Math.min(Math.max(0, (e.clientY - bcr.top) / bcr.height), 1) * 100}%)`
    });
};
window.onmousemove = (e)=>{
    ...
    if (interactingProject) {
        if (!interactingProjectTitle) cursorLinkIcon.classList.add("visible");
        else cursorLinkIcon.classList.remove("visible");
        cursorAnimate(e, "project");
    } else cursorLinkIcon.classList.remove("visible");
};

},{"locomotive-scroll":"iDXE3","./menu":"dTgwB","./loading":"2THKT","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"iDXE3":[function(require,module,exports) {
...
},{"./disableScroll":"8tGsy"}],"8tGsy":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
